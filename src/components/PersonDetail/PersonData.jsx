...
const PersonData = ({data,fetchPersonDetail,PersonDetail,isLoadingPersonDetail})=>{
    useEffect (() => {
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-8 person-text col-12 vh_center">
                            ...
                            <div className="d-flex flex-row flex-wrap align-items-center">
                                ...
                                <h6 className="mr-2 text-warning">{PersonDetail.gender===2 ? 'Male': 'Female'}</h6>
                                <h6 className="mr-2 text-warning">{PersonDetail.known_for_department}</h6>
                                <h6 className="mr-2 text-warning">{PersonDetail.popularity}%</h6>
                            </div>
                            <b className="heading_color">BIOGRAPHY: </b>
                            <p>{PersonDetail.biography ? PersonDetail.biography : <i>No biography available</i>}</p>
                            {(PersonDetail.also_known_as && PersonDetail.also_known_as.length>1) &&
                                <>
